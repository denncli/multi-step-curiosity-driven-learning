...
def add_optimization_params(parser):
    ...
    parser.add_argument('--pred_discount', type=float, default=0.2)     # Scale factor for t2 loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--feat_learning', type=str, default="none", #default seems to be random features?
